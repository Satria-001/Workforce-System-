                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <a href="/" class="mb-4 block">
                            <img class="dark:hidden" src="/images/logo/workforce-system_primary_dark.png" alt="Logo" />
                            <img class="hidden dark:block" src="/images/logo/workforce-system_primary_light.png" alt="Logo" />
                        </a>
                        <p class="text-center text-gray-400 dark:text-white/60">
                            Sistem manajemen tenaga kerja terpusat untuk operasional harian.
                        </p>
                    </div>
                </div>
            </div>
