...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-maskmoney/3.1.1/jquery.maskMoney.min.js" defer></script>
...
<script>
    ...
    // Fallback: hide loader after 3 seconds to prevent infinite loading
    setTimeout(function() {
        var loader = document.getElementById('loader');
        if (loader) {
            loader.style.display = 'none';
