    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <a href="/" class="xl:hidden">
                <img class="dark:hidden" src="/images/logo/workforce-system_primary_light.png" alt="Logo" />
                <img class="hidden dark:block" src="/images/logo/workforce-system_primary_dark.png" alt="Logo" />
            </a>
